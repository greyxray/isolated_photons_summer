...
*/
	...
	*/
	...
	//*******************
	cout << "Integrals: mc QQ: " << hist_mc_sum[g_index_deltaz]->Integral() << " mc LL: " << hist_mc_rad_sum[g_index_deltaz]->Integral() \
	<< " mc bg: " << hist_mc_norad_sum[g_index_deltaz]->Integral() << " data: " << hist_data_sum [g_index_deltaz]->Integral()<<endl;
	...
	{		
		...
		for(Int_t j = 0; j < hist_mc_sum[i]->GetNbinsX(); j++)
		{
			...
			Double_t add_err1 = pow((param_err[0] * hist_mc_sum[i]->GetBinContent(j+1) / param[0]), 2);
			Double_t add_err2 = pow(err * param[0], 2);
