...
// ------------>Primitives in pad: canv_cross_et_1
   ...
   grae->SetPoint(0,5,2.513442);
   grae->SetPointError(0,0,0,0.2995765,0.2811069);
   grae->SetPoint(1,7,1.386701);
   grae->SetPointError(1,0,0,0.1433389,0.07232096);
   grae->SetPoint(2,9,0.6622037);
   grae->SetPointError(2,0,0,0.04850206,0.03830417);
   grae->SetPoint(3,12.5,0.2543196);
   grae->SetPointError(3,0,0,0.01408771,0.01581083);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,4.25,13.25);
   Graph_Graph1->SetMinimum(0);
   Graph_Graph1->SetMaximum(3.04998);
   ...
   grae->SetPoint(0,5,2.513442);
   grae->SetPointError(0,0,0,0.3596681,0.2814785);
   grae->SetPoint(1,7,1.386701);
   grae->SetPointError(1,0,0,0.1809657,0.1562213);
   grae->SetPoint(2,9,0.6622037);
   grae->SetPointError(2,0,0,0.09250252,0.1113936);
   grae->SetPoint(3,12.5,0.2543196);
   grae->SetPointError(3,0,0,0.03161138,0.04002039);
   grae->Draw("e ");
