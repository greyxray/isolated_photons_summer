...
void Hist::PlotCrossSec() {
  ...
  apply_hadronisation_corrections();//warning
  ...
  for(Int_t i=0; i<n_cross; i++) {
    ...
    Double_t xmax = h_Spiesberger_pos_nlo[i]->GetXaxis()->GetXmax();
    ...
    h_Spiesberger_ele_nlo[i]->SetFillStyle(3225);
    ...
    h_Zotov[i]->SetLineColor(kYellow);
  ...
  for(Int_t i=0; i<n_cross; i++) {
    ...
    leg_cross[i]->AddEntry(h_Spiesberger_ele_nlo[0], "GKS", "f");
    ...
    leg_cross[i]->AddEntry(h_Zotov[0], "BLZ", "fl");
  ...
  for(Int_t i=0; i<n_cross; i++){
    c_cross[i] = new TCanvas("canv_cross_" + s_var[i], "", 1200, 900);
  ...
  for(Int_t i=0; i<n_cross; i++){
    ...
    if(i==0) {
      //      plot_box(number_etbins, x_et_bin, et_bin_err, et_bin_err, y_Spiesberger_ele_nlo_et, y_Spiesberger_ele_nlo_et_min, y_Spiesberger_ele_nlo_et_max);
      plot_box_posele(number_etbins, x_et_bin, et_bin_err, et_bin_err, y_Spiesberger_ele_nlo_et, y_Spiesberger_ele_nlo_et_min, y_Spiesberger_ele_nlo_et_max, y_Spiesberger_pos_nlo_et, y_Spiesberger_pos_nlo_et_min, y_Spiesberger_pos_nlo_et_max);
    }
    if(i==1) {
      plot_box_posele(number_etabins, x_eta_bin, eta_bin_crosssec_err, eta_bin_crosssec_err, y_Spiesberger_ele_nlo_eta, y_Spiesberger_ele_nlo_eta_min, y_Spiesberger_ele_nlo_eta_max, y_Spiesberger_pos_nlo_eta, y_Spiesberger_pos_nlo_eta_min, y_Spiesberger_pos_nlo_eta_max);
    }
    if(i==2) {
      plot_box_posele(number_Q2bins, x_Q2_bin, Q2_bin_err, Q2_bin_err, y_Spiesberger_ele_nlo_Q2, y_Spiesberger_ele_nlo_Q2_min, y_Spiesberger_ele_nlo_Q2_max, y_Spiesberger_pos_nlo_Q2, y_Spiesberger_pos_nlo_Q2_min, y_Spiesberger_pos_nlo_Q2_max);
    }
    if(i==3) {
      plot_box_posele(number_xbins, x_x_bin, x_bin_err, x_bin_err, y_Spiesberger_ele_nlo_x, y_Spiesberger_ele_nlo_x_min, y_Spiesberger_ele_nlo_x_max, y_Spiesberger_pos_nlo_x, y_Spiesberger_pos_nlo_x_min, y_Spiesberger_pos_nlo_x_max);
    }
    if(i==4) {
      plot_box_posele(number_et_jetbins, x_et_jet_bin, et_jet_bin_err, et_jet_bin_err, y_Spiesberger_ele_nlo_et_jet, y_Spiesberger_ele_nlo_et_jet_min, y_Spiesberger_ele_nlo_et_jet_max, y_Spiesberger_pos_nlo_et_jet, y_Spiesberger_pos_nlo_et_jet_min, y_Spiesberger_pos_nlo_et_jet_max);
    }
    if(i==5) {
      plot_box_posele(number_eta_jetbins, x_eta_jet_bin, eta_jet_bin_err, eta_jet_bin_err, y_Spiesberger_ele_nlo_eta_jet, y_Spiesberger_ele_nlo_eta_jet_min, y_Spiesberger_ele_nlo_eta_jet_max, y_Spiesberger_pos_nlo_eta_jet, y_Spiesberger_pos_nlo_eta_jet_min, y_Spiesberger_pos_nlo_eta_jet_max);
    }
