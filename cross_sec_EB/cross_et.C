...
// ------------>Primitives in pad: canv_cross_et_1
   ...
   h_cross_section_et_stat_fit_err->SetBinContent(1,2.513442);
   h_cross_section_et_stat_fit_err->SetBinContent(2,1.386701);
   h_cross_section_et_stat_fit_err->SetBinContent(3,0.6622037);
   h_cross_section_et_stat_fit_err->SetBinContent(4,0.2543196);
   h_cross_section_et_stat_fit_err->SetBinError(1,0.1939117);
   h_cross_section_et_stat_fit_err->SetBinError(2,0.1054673);
   h_cross_section_et_stat_fit_err->SetBinError(3,0.07550821);
   h_cross_section_et_stat_fit_err->SetBinError(4,0.02587229);
   h_cross_section_et_stat_fit_err->SetEntries(13883);
