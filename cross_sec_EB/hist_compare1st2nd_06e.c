void Hist::Compare1st2nd(Int_t n, TH1D** h_1st, TH1D** h_2nd)
{
  ...
  if(s_var[n] == "et") {
    ...
    h_1st[0]->SetBinContent(1, 1.50578 + 0.468666);
    h_1st[0]->SetBinError(1, );
    h_1st[0]->SetBinContent(2, );
    h_1st[0]->SetBinError(2, );
    h_1st[0]->SetBinContent(3, );
    h_1st[0]->SetBinError(3, );
    h_1st[0]->SetBinContent(4, );
    h_1st[0]->SetBinError(4, );
  }
  if(s_var[n] == "eta") {
