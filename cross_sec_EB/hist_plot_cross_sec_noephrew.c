...
void Hist::PlotCrossSec() {
  ...
  for(Int_t i=0; i<n_cross; i++) {
    ...
    leg_1st2nd[i]->AddEntry(h_1st_cross[i][0], "without E^{#gamma}-rew.", "p");
    leg_1st2nd[i]->AddEntry(h_cross[i][0], "with E^{#gamma}-rew.", "p");
  }
  ...
  h_window_cross[0][1] = new TH2D("h_window_cross_ratio_" + s_var[0], "", number_etbins, et_bin, 10, -0.04, 0.04);
