...
// ------------>Primitives in pad: canv_cross_eta_jet_1
   ...
   grae->SetPoint(0,-1.1,1.692533);
   grae->SetPointError(0,0,0,0.2503466,0.1997345);
   grae->SetPoint(1,-0.3,3.114765);
   grae->SetPointError(1,0,0,0.2378264,0.2032517);
   grae->SetPoint(2,0.5,4.091523);
   grae->SetPointError(2,0,0,0.300537,0.2975373);
   grae->SetPoint(3,1.35,3.524909);
   grae->SetPointError(3,0,0,0.3747574,0.2450931);
   
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Graph",100,-1.345,1.595);
   Graph_Graph6->SetMinimum(1.147499);
   Graph_Graph6->SetMaximum(4.683748);
   ...
   h_cross_section_eta_jet->SetEntries(13887);
   ...
   grae->SetPoint(0,-1.1,1.692533);
   grae->SetPointError(0,0,0,0.308878,0.2558601);
   grae->SetPoint(1,-0.3,3.114765);
   grae->SetPointError(1,0,0,0.3545649,0.3719002);
   grae->SetPoint(2,0.5,4.091523);
   grae->SetPointError(2,0,0,0.4649164,0.5016468);
   grae->SetPoint(3,1.35,3.524909);
   grae->SetPointError(3,0,0,0.4881745,0.4424279);
   grae->Draw("e ");
