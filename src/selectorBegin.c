...
void selector::Begin(/*TTree * /*tree*/)
{
  ...
  if (nodebugmode) cout << "root file name: " << root_file_name << endl;
  ...
  if (nodebugmode) cout << "======= C_scale ========" << endl;
  for(Int_t i=0; i<number_of_eta_bins; i++)
      if (nodebugmode) cout << C_scale[i] << endl;
  ...
  if (nodebugmode) cout << "++++++==== a0 ---- a1 ======++++++" << endl;
  for(Int_t i=0; i<number_of_eta_bins; i++)
      if (nodebugmode) cout << a0_corr[i] << "   " << a1_corr[i] << endl;
  /*
