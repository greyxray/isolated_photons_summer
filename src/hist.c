...
void Hist::Init(TDirectory** dir)
{
  ...
  //*** Cross_Section_histograms -> for fit fmax and deltaz in different bins and cross sections
  dir[4]->cd();
  ...
  //*** Photon_with_jet -> control distributions photon + jet
  dir[2]->cd();
  ...
  //*** Inclusive_DIS -> control distributions inclusive DIS
  dir[0]->cd();
  ...
  //*** MC_gen_recon_corel -> correlation of generated and reconstructed values
  dir[1]->cd();
