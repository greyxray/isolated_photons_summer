...
// ------------>Primitives in pad: canv_cross_eta_1
   ...
   canv_cross_eta_1->cd();
   canv_cross_eta_1->Range(-0.9536585,0.05,0.997561,22);
   ...
   TH2D *h_window_cross_eta = new TH2D("h_window_cross_eta","",4, xAxis78,10,0.05,22);
   ...
   h_cross_section_eta->SetBinContent(1,7.356852);
   h_cross_section_eta->SetBinContent(2,6.450967);
   h_cross_section_eta->SetBinContent(3,5.552284);
   h_cross_section_eta->SetBinContent(4,5.058734);
   h_cross_section_eta->SetBinError(1,0.6340117);
   h_cross_section_eta->SetBinError(2,0.5619588);
   h_cross_section_eta->SetBinError(3,0.5623734);
   h_cross_section_eta->SetBinError(4,0.5466694);
   h_cross_section_eta->SetEntries(14141);
   ...
   h_cross_section_eta_1st_analysis->SetBinContent(1,17.4);
   h_cross_section_eta_1st_analysis->SetBinContent(2,13);
   h_cross_section_eta_1st_analysis->SetBinContent(3,10.7);
   h_cross_section_eta_1st_analysis->SetBinContent(4,8.7);
   h_cross_section_eta_1st_analysis->SetBinError(1,0.9);
   h_cross_section_eta_1st_analysis->SetBinError(2,0.8);
   h_cross_section_eta_1st_analysis->SetBinError(3,0.9);
   h_cross_section_eta_1st_analysis->SetBinError(4,0.9);
   h_cross_section_eta_1st_analysis->SetEntries(14145);
   ...
   TLegendEntry *entry=leg->AddEntry("h_cross_section_eta_1st_analysis","Matthew","p");
   ...
   entry=leg->AddEntry("h_cross_section_eta","Oleg & Nataliia","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
...
// ------------>Primitives in pad: canv_cross_eta_2
   ...
   canv_cross_eta_2->cd();
   canv_cross_eta_2->Range(-0.9536585,-0.875,0.997561,0.525);
   ...
   TH2D *h_window_cross_ratio_eta = new TH2D("h_window_cross_ratio_eta","",4, xAxis81,10,-0.525,0.525);
   ...
   h_cross_section_eta_ratio_1st_analysis->SetBinContent(1,-1.365142);
   h_cross_section_eta_ratio_1st_analysis->SetBinContent(2,-1.015202);
   h_cross_section_eta_ratio_1st_analysis->SetBinContent(3,-0.9271348);
   h_cross_section_eta_ratio_1st_analysis->SetBinContent(4,-0.7197977);
   h_cross_section_eta_ratio_1st_analysis->SetBinError(1,0.2377213);
   h_cross_section_eta_ratio_1st_analysis->SetBinError(2,0.2149338);
   h_cross_section_eta_ratio_1st_analysis->SetBinError(3,0.2537231);
   h_cross_section_eta_ratio_1st_analysis->SetBinError(4,0.2572778);
   h_cross_section_eta_ratio_1st_analysis->SetEntries(14145);
