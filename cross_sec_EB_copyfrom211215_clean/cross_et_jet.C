...
// ------------>Primitives in pad: canv_cross_et_jet_1
   ...
   h_cross_section_et_jet_stat_fit_err->SetBinContent(1,1.394513);
   h_cross_section_et_jet_stat_fit_err->SetBinContent(2,1.242432);
   h_cross_section_et_jet_stat_fit_err->SetBinContent(3,1.01108);
   h_cross_section_et_jet_stat_fit_err->SetBinContent(4,0.7783826);
   h_cross_section_et_jet_stat_fit_err->SetBinContent(5,0.31625);
   h_cross_section_et_jet_stat_fit_err->SetBinContent(6,0.03153496);
   h_cross_section_et_jet_stat_fit_err->SetBinError(1,0.1772116);
   h_cross_section_et_jet_stat_fit_err->SetBinError(2,0.1099003);
   h_cross_section_et_jet_stat_fit_err->SetBinError(3,0.0963281);
   h_cross_section_et_jet_stat_fit_err->SetBinError(4,0.06793119);
   h_cross_section_et_jet_stat_fit_err->SetBinError(5,0.0313499);
   h_cross_section_et_jet_stat_fit_err->SetBinError(6,0.00456096);
   h_cross_section_et_jet_stat_fit_err->SetEntries(14097);
