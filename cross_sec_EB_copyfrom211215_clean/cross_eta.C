...
// ------------>Primitives in pad: canv_cross_eta_1
   ...
   h_cross_section_eta_stat_fit_err->SetBinContent(1,7.687964);
   h_cross_section_eta_stat_fit_err->SetBinContent(2,6.902884);
   h_cross_section_eta_stat_fit_err->SetBinContent(3,5.75602);
   h_cross_section_eta_stat_fit_err->SetBinContent(4,5.318706);
   h_cross_section_eta_stat_fit_err->SetBinError(1,0.5543493);
   h_cross_section_eta_stat_fit_err->SetBinError(2,0.5708499);
   h_cross_section_eta_stat_fit_err->SetBinError(3,0.6121733);
   h_cross_section_eta_stat_fit_err->SetBinError(4,0.5289333);
   h_cross_section_eta_stat_fit_err->SetEntries(14095);
