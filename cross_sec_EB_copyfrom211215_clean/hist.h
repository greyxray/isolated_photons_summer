 ...
 * ... hist where we describe the vars
 */
#ifndef HIST_h
#define HIST_h
#include <TH1D.h>
...
/*! 
  ...
  \brief class Hist.
          class Hist - handles all histos and methods.
 
  many lines of explanation. Init() is initial
 */
class Hist
{
 public:
...
enum {n_hist = 6};//take care 7 - if dZ is already implemented
