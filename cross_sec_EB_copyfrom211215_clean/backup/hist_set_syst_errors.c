void Hist::SetSystematicErrors(Int_t n, TH1D** h_1st, TH1D** h_2nd, TGraphAsymmErrors** gr_2nd)
{
  ...
  Double_t y3_5[number_Q2bins] = {0.0694263286, 0.0303045255, 0.1144783219, 0.1732685955};    //Q2 et_jet_delta_minus
  Double_t my3_5[number_Q2bins] = {-0.0694263286, -0.0303045255, -0.1144783219, -0.1732685955};    //Q2 et_jet_delta_minus
  Double_t y3_6[number_Q2bins] = {0.0681457064, 0.0196989574, 0.0683708038, 0.0642655769};    //Q2 et_jet_delta_plus
  ...
  Double_t y7_5[number_Q2bins] = {0.0195235611, 0.0359062623, 0.0317489649, 0.0965727873};    //q2 en_photon_delta_minus
  Double_t my7_5[number_Q2bins] = {-0.0195235611, -0.0359062623, -0.0317489649, -0.0965727873};    //q2 en_photon_delta_minus
  Double_t y7_6[number_Q2bins] = {0.0140749875, 0.0134122414, 0.0229203025, 0.0453639367};    //q2 en_photon_delta_plus
  ...
  */
  Double_t y11_5[number_Q2bins] = {0.0340194939, 0.0155919846, 0.0414947131, 0.0355179975};    //q2 en_electron_delta_minus
  Double_t my11_5[number_Q2bins] = {-0.0340194939, -0.0155919846, -0.0414947131, -0.0355179975};    //q2 en_electron_delta_minus
  Double_t y11_6[number_Q2bins] = {0.0622643299, 0.0252977918, 0.0648667146, 0.0512515662};    //q2 en_electron_delta_plus
  ...
  */
  ...
  Double_t y15_5[number_Q2bins] = {0.0508039462, 0.1924675506, 0.0315368032, 0.0511732544};    //Q2 deltaZ_delta_minus
  Double_t my15_5[number_Q2bins] = {-0.0508039462, -0.1924675506, -0.0315368032, -0.0511732544};    //Q2 deltaZ_delta_minus
  Double_t y15_6[number_Q2bins] = {0.0532821875, 0.0500179952, 0.0558532663, 0.0817433648};    //Q2 deltaZ_delta_plus
  ...
  if(s_var[n] == "et") {
    for(Int_t i=0; i<h_2nd[0]->GetNbinsX(); i++){
      ...
      cout << "et syst: " << i << " " << total_syst_minus_et[i] << " " << total_syst_plus_et[i] << endl;
    }
