...
void Hist::PlotCrossSec() {
  ...
  h_window_cross[0][0] = new TH2D("h_window_cross_" + s_var[0], "", number_etbins, et_bin, 10, 0.05, 6.);
  h_window_cross[0][1] = new TH2D("h_window_cross_ratio_" + s_var[0], "", number_etbins, et_bin, 10, -0.325, 0.325);
  h_window_cross[1][0] = new TH2D("h_window_cross_" + s_var[1], "", number_etabins, eta_bin_crosssec, 10, 0.05, 22.);
