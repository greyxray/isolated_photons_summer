...
// ------------>Primitives in pad: canv_cross_x_1
   ...
   h_cross_section_x_stat_fit_err->SetBinContent(0,5.564609);
   h_cross_section_x_stat_fit_err->SetBinContent(1,5029.562);
   h_cross_section_x_stat_fit_err->SetBinContent(2,1858.056);
   h_cross_section_x_stat_fit_err->SetBinContent(3,280.5166);
   h_cross_section_x_stat_fit_err->SetBinContent(4,28.81369);
   h_cross_section_x_stat_fit_err->SetBinContent(5,14.93033);
   h_cross_section_x_stat_fit_err->SetBinError(0,0.8243007);
   h_cross_section_x_stat_fit_err->SetBinError(1,348.3438);
   h_cross_section_x_stat_fit_err->SetBinError(2,143.0558);
   h_cross_section_x_stat_fit_err->SetBinError(3,30.30775);
   h_cross_section_x_stat_fit_err->SetBinError(4,6.199256);
   h_cross_section_x_stat_fit_err->SetBinError(5,1.033642);
   h_cross_section_x_stat_fit_err->SetEntries(14095);
