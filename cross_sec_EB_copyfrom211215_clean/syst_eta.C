...
// ------------>Primitives in pad: canv_cross_eta_1
   ...
   grae->SetPoint(0,-0.5,7.687964);
   grae->SetPointError(0,0,0,1.137145,0.9072503);
   grae->SetPoint(1,-0.1,6.902884);
   grae->SetPointError(1,0,0,0.5270664,0.4504426);
   grae->SetPoint(2,0.3,5.75602);
   grae->SetPointError(2,0,0,0.4228003,0.4185803);
   grae->SetPoint(3,0.7,5.318706);
   grae->SetPointError(3,0,0,0.5654683,0.3698189);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,-0.62,0.82);
   Graph_Graph2->SetMinimum(4.36904);
   Graph_Graph2->SetMaximum(8.979412);
   ...
   grae->SetPoint(0,-0.5,7.687964);
   grae->SetPointError(0,0,0,1.27943,0.8292659);
   grae->SetPoint(1,-0.1,6.902884);
   grae->SetPointError(1,0,0,0.7937534,0.8393395);
   grae->SetPoint(2,0.3,5.75602);
   grae->SetPointError(2,0,0,0.7563687,0.8869426);
   grae->SetPoint(3,0.7,5.318706);
   grae->SetPointError(3,0,0,0.7924958,0.7852328);
   grae->Draw("e ");
