...
void Hist::PlotCrossSec() {
  ...
  for(Int_t i=0; i<n_cross; i++) {
    ...
    leg_1st2nd[i]->AddEntry(h_1st_cross[i][0], "without reweightings", "p");
    leg_1st2nd[i]->AddEntry(h_cross[i][0], "with reweightings", "p");
  }
  ...
  h_window_cross[0][1] = new TH2D("h_window_cross_ratio_" + s_var[0], "", number_etbins, et_bin, 10, -0.1, 0.1);
  h_window_cross[1][0] = new TH2D("h_window_cross_" + s_var[1], "", number_etabins, eta_bin_crosssec, 10, 0.05, 10.);
  h_window_cross[1][1] = new TH2D("h_window_cross_ratio_" + s_var[1], "", number_etabins, eta_bin_crosssec, 10, -0.1, 0.1);
  h_window_cross[2][0] = new TH2D("h_window_cross_" + s_var[2], "", number_Q2bins, Q2_bin, 10, 1.e-3, 1.);
  h_window_cross[2][1] = new TH2D("h_window_cross_ratio_" + s_var[2], "", number_Q2bins, Q2_bin, 10, -0.1, 0.1);
  h_window_cross[3][0] = new TH2D("h_window_cross_" + s_var[3], "", number_xbins, x_bin, 10, 11., 1.e4);
  h_window_cross[3][1] = new TH2D("h_window_cross_ratio_" + s_var[3], "", number_xbins, x_bin, 10, -0.1, 0.1);
  ...
  h_window_cross[5][1] = new TH2D("h_window_cross_ratio_" + s_var[5], "", number_eta_jetbins, eta_jet_bin, 10, -0.1, 0.1);
