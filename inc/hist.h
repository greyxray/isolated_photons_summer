...
class Hist
{
 public:
  ...
  //Cross_Section_Histograms : for fmax & deltaz fit in different bins and cross sections:
    TH1D* det_Q2;//to study Q2 ststistic
  ...
  //Inclusive_photon : control distributions inclusive photon
    TH1D* incl_phot_fmax;
